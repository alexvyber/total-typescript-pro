...
const exerciseFiles = allExercises.filter(exercise => exercise.includes(".problem."))
const exerciseNames = exerciseFiles.map(exercise => path.parse(exercise).base.split("-")[0])
