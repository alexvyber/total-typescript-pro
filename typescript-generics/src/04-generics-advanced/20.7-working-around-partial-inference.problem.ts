...
export const makeSelectors =
  <Source = "makeSelectors expects to be passed a type argument">() =>
  <Selectors extends Record<string, (source: Source) => any>>(selectors: Selectors) =>
    selectors
...
type tests = [
  ...
  Expect<Equal<(typeof selectors)["getFirstAndLastName"], (source: Source) => string>>,
  Expect<Equal<(typeof selectors)["getFirstNameLength"], (source: Source) => number>>,
]
